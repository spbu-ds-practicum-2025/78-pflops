...
5. Перейти в секцию поиска, выполнить поиск так, чтобы новое объявление попало в результаты (например, по заголовку).
6. Найти карточку нового объявления в списке.
7. Нажать на карточку объявления.
8. На странице объявления обратить внимание на:
   - Большое основное изображение.
   - Ряд миниатюр всех изображений.
9. Кликнуть по разным миниатюрам.
...
3. Нажать «Опубликовать объявление».
4. Дождаться уведомления об успехе.
5. Открыть профиль (кнопка профиля в шапке).
6. В разделе «Мои объявления» кликнуть по нужному объявлению.
7. На отдельной странице объявления:
...
9. Обновить страницу объявления или снова открыть его через поиск.
...
4. Дождаться уведомления об успехе.
5. Перейти в секцию поиска, выполнить поиск так, чтобы новое объявление попало в результаты (например, по заголовку).
6. Открыть объявление через профиль или поиск и перейти на отдельную страницу.
7. Нажать кнопку «Удалить» на странице объявления.
8. Подтвердить удаление в диалоге браузера (если появляется `confirm`).
9. После успешного уведомления:
...
3. При выборе режима "пользователь" без успешного входа попытаться нажать «Опубликовать объявление».
...
### Тест 5.1: Полный сквозной сценарий пользователя
...
2. Выйти за аккаунта.
3. Войти в созданный на шаге 1 аккаунт
4. Создать объявление с несколькими изображениями (Тест 2.1).
5. Найти и открыть созданное объявление в отдельной странице (Тест 2.2).
6. Отредактировать объявление (изменить текст и заменить изображения) (Тест 3.1).
7. Проверить, что изменения видны в списке и на отдельной странице.
8. Открыть профиль, проверить, что объявление есть в «Мои объявления» (Тест 4.2).
9. Удалить объявление со страницы объявления (Тест 3.2).
10. Проверить, что:
